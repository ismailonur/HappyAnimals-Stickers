...
public class StickerPackInfoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StartAppSDK.init(this, "211233804", false);
        setContentView(R.layout.activity_sticker_pack_info);
        StartAppSDK.init(this, "211233804", new SDKAdPreferences()
                .setAge(20));
  ...
  /* Geri tuşuna basıldığı zaman reklam çıkması (info kısmı için) public void onBackPressed() {
